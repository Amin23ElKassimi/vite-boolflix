<template lang="">
  ...
  <select v-model="selectedLanguage" @change="fetchLanguageFlag">
    <option value="en">Afghanistam</option>
    <option value="es">Palestine</option>
    <!-- Aggiungi altre opzioni per le lingue che vuoi supportare -->
  </select>
